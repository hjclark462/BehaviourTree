...
namespace AISystem
{
    public class AIBeing : MonoBehaviour, IBeing
    {
        ...
        [field: SerializeField] public AISettings m_aISettings { get; private set; } = new();
        ...
        {       
            ...
            AIMovement aIMovement = new AIMovement(m_aISettings.MovementSettings, m_animator, this, m_aiManager, m_rootMotionSync);
            BehaviourManager behaviourManager = new BehaviourManager(UnpackBehaviourTree(m_aISettings.BehaviourTree, new BehaviourInput()
            {
        ...
        List<IOptic> CreateOptics()
        {
            ...
            createdOptics.Add(new OpticSensor(m_aISettings.ObservationSettings, m_aiManager, this));
