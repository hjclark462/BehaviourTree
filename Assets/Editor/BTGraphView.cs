...
public class BTGraphView : GraphView
{
    ...
    public event System.Action<BTNode> SelectedNode;

    BTAsset m_bTAsset;
    Dictionary<BTNode, NodeView> m_nodeViewLUT = new();
    NodeView m_rootNode;
    ...
    void RebuildBehaviourTree()
    {
        ...
        void UnPackNodesRecursive(BTNode parent)
        {
            nodes.Add(parent);
    ...
    NodeData BuildNodeData(BTNode node)
    {
        if (node == null)
        {
            return new NodeData();
